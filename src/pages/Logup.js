        ...
        <div className='w-screen  flex justify-center items-center h-screen overflow-hidden bg-slate-200'>
            <div className="bg-white w-auto h-auto" style={styles.shadow}>
                ...
                <form className="w-full">
                    <InputText type="text" placehoder="Username" >
                    ...
                    <InputText type="email" placehoder="Email" >
                    ...
                    <InputText type="password" placehoder="Confirmation Password" >
                    ...
                    <div className="flex justify-around px-7 pt-7">
                        <button className=" w-full h-14 rounded bg-blue-500 text-white font-regular text-xl" type="submit">Sign Up</button>
                    </div>
