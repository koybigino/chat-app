...
function Contact({username, message, num, time, timegrade, imgpath, active}){
    ...
    return(
        <div className="flex justify-between items-center gap-x-1 py-3">
            ...
            <div className="w-1/12">
                <h6 className="font-bold text-sm">{time}{timegrade}</h6>
                <div className="text-white text-center text-sm bg-blue-500 rounded-sm" style={{ padding: "0.5px",}}>{num}</div>
            </div>
        </div>
    )
}
