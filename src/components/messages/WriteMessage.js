    ...
    return (
        <div className="flex px-5 items-center justify-between border-t h-[80px]">
            ...
            <div className="px-3 w-10/12 bg-gray-100 rounded-lg pl-5 flex justify-center items-center">
                <textarea rows="1" placeholder="Send message..." onChange={resize} style={styles.text} className="text-gray-500 bg-gray-100 placeholder:text-sm max-h-14 h-fit text-sm focus:outline-0 py-3 focus:text-sm focus:text-gray-500 w-full">
